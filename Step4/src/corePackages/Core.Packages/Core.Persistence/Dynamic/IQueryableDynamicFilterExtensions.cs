...
{   /*static anahtar kelimesi, C# programlama dilinde bir sınıfın nesnesinin oluşturulmadan doğrudan erişilebilir olduğunu belirtir. Yani, bir sınıfın static olarak işaretlenmesi, o sınıfın bir örneği oluşturulmadan doğrudan sınıf adı üzerinden erişilebilir olduğu anlamına gelir.*/
